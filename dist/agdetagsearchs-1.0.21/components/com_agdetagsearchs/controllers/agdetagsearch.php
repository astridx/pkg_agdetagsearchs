...
/**
 * Agdetagsearchs class.
 *
 * @since  1.5
 */
class AgdetagsearchsControllerAgdetagsearch extends JControllerForm
{
	/**
	...
	public function save($key = null, $urlVar = 'w_id')
	{
		...
		$app->setUserState('com_agdetagsearchs.edit.agdetagsearch.data', $data);
		...
		if ($result)
		{
			...
			$app->setUserState('com_agdetagsearchs.edit.agdetagsearch.data', null);
			$this->setRedirect($this->getReturnPage());
		}
	...
	public function go()
	{
		...
		$modelLink = $this->getModel('Agdetagsearch', '', array('ignore_request' => true));
		...
		$modelCat = $this->getModel('Category', 'AgdetagsearchsModel', array('ignore_request' => true));
