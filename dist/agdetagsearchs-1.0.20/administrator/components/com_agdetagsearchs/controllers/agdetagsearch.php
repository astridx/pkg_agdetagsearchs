...
/**
 * Agdetagsearch controller class.
 *
 * @since  1.6
 */
class AgdetagsearchsControllerAgdetagsearch extends JControllerForm
{
	 ...
	 * Important because JController makes  agdetagsearch_e_s  for this
	 *
	 * @var    string
	 * @since  1.6
	 */
	...
	public function batch($model = null)
	{
		...
		// Set the model
		$model = $this->getModel('Agdetagsearch', '', array());

		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_agdetagsearchs&view=agdetagsearchs' . $this->getRedirectToListAppend(), false));
