...
class AgdetagsearchsTableAgdetagsearch extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		JTableObserverTags::createObserver($this, array('typeAlias' => 'com_agdetagsearchs.agdetagsearch'));
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_agdetagsearchs.agdetagsearch'));
	}
	...
	public function store($updateNulls = false)
	{
		...
		if ($table->load(
			array('language' => $this->language, 'alias' => $this->alias,
			'catid' => $this->catid)
		)
