...
JHtml::_('script', 'com_agdetagsearchs/scriptfrontend.js', false, true);
JHtml::_('script', 'com_agdetagsearchs/js.cookie.js', false, true);
JHtml::_('stylesheet', 'com_agdetagsearchs/stylefrontend.css', false, true, false);
...
<?php else : ?>
<form action="<?php echo JRoute::_('index.php?option=com_agdetagsearchs'); ?>" method="post" name="adminForm" id="adminForm">
...
</div><div class="items-row row-fluid category list-condensed divaroundformfield">
		<?php endif; ?>
...
<!-- was li-->
<div class="<?php echo $spanClass; ?> system-unpublished list-striped cat-list cat-list-row<?php echo $i % 2; ?>">
			<?php else : ?>
...
<div class="agde_clear">
			...
			foreach ($tagsData as $tag) {
				...
				$agde_searchtags[] = JHtml::_('select.option', $tagid, $labelcontent);
			}
...
<div <?php echo $display; ?> class="<?php echo 'toggletarget_' . $item->alias ?>">
			<?php if ($item->fieldtype == 'select') : ?>
				<?php
				$list = JHtml::_('select.radiolist', $agde_searchtags, 'agdetagsearchs_' . $item->alias . '[]', 'multiple class="inputbox"', 'value', 'text', $values);
			...
			<?php if ($item->fieldtype == 'checkbox') : ?>
				<?php
				echo JHtml::_('select.radiolist', $agde_searchtags, 'agdetagsearchs_' . $item->alias . '[]', 'multiple class="inputbox"', 'value', 'text', $values[0]);
				?>
			<?php endif; ?>
</div>
</div>
...
<button
id="submitbutton"
name="agdetagsearchbutton"
value="submit"
class="btn hasTooltip"
title="<?php echo JHtml::_('tooltipText', 'COM_AGDETAGSEARCH_DEAGTAGSEARCH'); ?>"
>
...
<button
id="resetbutton"
name="agdetagresetbutton"
value="reset"
class="btn hasTooltip"
title="<?php echo JHtml::_('tooltipText', 'COM_AGDETAGSEARCH_DEAGTAGSRESET'); ?>"
>
