...
use AgdetagsearchsNamespace\Component\Agdetagsearchs\Site\Helper\AssociationHelper;
...
class AssociationsHelper extends AssociationExtensionHelper
{
	 ...
	 * @since   __BUMP_VERSION__
	 */
	protected $itemTypes = array('agdetagsearch', 'category');
	...
	public function getItem($typeName, $id)
	{
		...
		{
			case 'agdetagsearch':
				$table = Table::getInstance('AgdetagsearchTable', 'AgdetagsearchsNamespace\\Component\\Agdetagsearchs\\Administrator\\Table\\');
				break;
