...
class AdministratorService
{
	 ...
	 *
	 * @return  string	The anchor tag to toggle featured/unfeatured agdetagsearchs.
	 *
	 * @since   __BUMP_VERSION__
	 */
	public function featured($value, $i, $canChange = true)
	{
		...
		$states = array(
			0 => array('unfeatured', 'agdetagsearchs.featured', 'COM_CONTACT_UNFEATURED', 'JGLOBAL_ITEM_FEATURE'),
			1 => array('featured', 'agdetagsearchs.unfeatured', 'JFEATURED', 'JGLOBAL_ITEM_UNFEATURE'),
		);
